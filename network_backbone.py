    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        for module in self.net:
            if isinstance(module, torch.nn.Linear):
                project_states = module(hidden_states)
            elif isinstance(module, Lora_layer):
                lora_states = module(hidden_states)
            else: hidden_states = module(hidden_states)
        result = project_states + lora_states
        return result
