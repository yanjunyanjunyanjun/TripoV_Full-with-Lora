...
class DINOSingleImageTokenizer(torch.nn.Module):
    def __init__(self, img_size, depth, embed_dim, official):
        ...
        if self.official:
            ...
            if 0:
                state_dict = torch.load('Dino_VIT_BASE8.pth')  #https://dl.fbaipublicfiles.com/dino/dino_deitsmall16_pretrain/dino_deitsmall16_pretrain.pth  https://dl.fbaipublicfiles.com/dino/dino_deitsmall8_300ep_pretrain/dino_deitsmall8_300ep_pretrain.pth  https://dl.fbaipublicfiles.com/dino/dino_vitbase8_pretrain/dino_vitbase8_pretrain.pth
